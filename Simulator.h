...
public:
	...
	void show_stats()
	{
		...
		std::cout << "Average wait time for the landing queue: " << (landing_queue->total_wait) / (landing_queue->num_served) << std::endl;
		...
		std::cout << "The average wait time for the departue queue is: " << (departure_queue->total_wait) / (departure_queue->num_served) << std::endl;
